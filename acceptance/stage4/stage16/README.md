...
Согласованный продуктовый процесс первичного наполнения, его границы
применимости и порядок реализации описаны в
[инструкции Gold](../../../docs/GOLD_KNOWLEDGE_INGESTION.md).
До прохождения её сквозной приёмки наличие инструкции не снимает этот блокер.
