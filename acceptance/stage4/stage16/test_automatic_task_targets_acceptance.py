...
from synapse.experiments.gold.run_inputs import FrozenGoldInputs, reopen_frozen_inputs, FROZEN_INPUT_SCHEMA_V7
...
def test_ordinary_task_resolves_project_targets_through_canonical_run_and_resume(tmp_path):
    ...
    assert frozen.data['schema_version'] == FROZEN_INPUT_SCHEMA_V7
