...
Проверено относительно `main` на post-merge P3c-1 commit `88210654223b19a52bfddf9f3715e1a95af90367`.
...
| Distributed consensus | **Partial — P3b local actor-method vote source verified; P3c-0 replay consumption closed; P3c-1 durable ticket creation/replay closed** | `P3a IMPLEMENTED / VERIFIED_ON_MAIN / S1/S2 EVIDENCE CLOSED`; `P3b POST_MERGE_ACCEPTED / EVIDENCE CLOSED`; `P3c-0 POST_MERGE_ACCEPTED / EVIDENCE CLOSED`; `P3c-1 POST_MERGE_ACCEPTED / EVIDENCE CLOSED` | P3a provides the deterministic semantic core. P3b verifies explicit local actor-method VoteSource. P3c-0 closes local replay consumption for `distributed_consensus_decided`. P3c-1 closes deterministic ticket creation, adjacent `distributed_consensus_ticket_created` emission, raw-adjacent ticket replay consumption, fail-closed ticket schema validation, cursor rollback, and `consensus_tickets` projection. Broader lifecycle and production protocol behavior remain future work. Evidence: `docs/evidence/P3A_EVIDENCE.md`, `docs/evidence/P3B_EVIDENCE.md`, `docs/evidence/P3C_EVIDENCE.md`, `docs/evidence/P3C1_EVIDENCE.md`, PR #27 `60db4d3aa610c0cab6ec19cf532b47b7107de136`, PR #31 `dbdfc7252c83d9fc4be0f0b5eb2cbd2007f0e2ad`, PR #34 `16fdd5fb209a9ab387359888bf1952571cfe8fba`, PR #39 `88210654223b19a52bfddf9f3715e1a95af90367`. |
