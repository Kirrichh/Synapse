...
class MiniAdapterFactory:
    def create(self, configuration):
        ...
        from synapse.worker.local_edits import LOCAL_EDIT_PROFILE_V4, LOCAL_EDIT_PROFILE_V5, LOCAL_EDIT_PROFILE_V6
        if config.input_profile not in {LOCAL_EDIT_PROFILE_V4, LOCAL_EDIT_PROFILE_V5, LOCAL_EDIT_PROFILE_V6}:
            raise ValueError('new Mini profiles require the governed local-edit v4, v5 or v6 boundary')
