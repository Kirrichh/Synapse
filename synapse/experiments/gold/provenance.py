...
class PlatformAttester:
    ...
    def __init__(self, *args: object, **kwargs: object) -> None:
        if kwargs.pop("_seal", None) is not _TRUSTED_ATTESTER_SEAL or kwargs or len(args) != 2:
            raise TypeError("PlatformAttester is created only by configure_platform_attester")
        self._attester_identity = _actor(args[0], "attester_identity")
        self._builder_runtime_identity = BuilderRuntimeIdentity.from_dict(args[1].to_dict())
...
def configure_platform_attester(
    *,
    ...
    _actor(attester_identity, "attester_identity")
    _validate_builder(builder_runtime_identity)
    return PlatformAttester(attester_identity, builder_runtime_identity, _seal=_TRUSTED_ATTESTER_SEAL)
...
def behavior_attestation_from_dict(
    ...
    *,
    ...
    fields = (
        "schema_version", "subject_content_key", "producer_run_id", "producer_attempt_id",
