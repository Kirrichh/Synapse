...
class RecordKind:
    ...
    REUSE_PROMOTION = "reuse-promotion"
    ...
    OBSERVABILITY = (OBSERVATION, OBSERVABILITY_MANIFEST, OBSERVABILITY_LINEAGE, GOLD_EVENT)
    ...
    ALL = (
        ...
        PREPARATION_FAILURE,
        RUN_RESULT,
        OBSERVATION, OBSERVABILITY_MANIFEST, OBSERVABILITY_LINEAGE, GOLD_EVENT,
    )
