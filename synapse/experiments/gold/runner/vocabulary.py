...
class AttemptOutcome(str, Enum):
    ...
    REUSE_GUARD_REFUSED = "ATTEMPT_REUSE_GUARD_REFUSED"
...
class RunFinalStatus(str, Enum):
    ...
    GOLD_STOPPED_NO_PROGRESS = "GOLD_STOPPED_NO_PROGRESS"
...
TERMINAL_DECISIONS = frozenset(
    {
        ...
        TerminalDecisionKind.STOP_NO_PROGRESS,
...
_FINAL_STATUS_BY_DECISION: dict[TerminalDecisionKind, RunFinalStatus] = {
    ...
    TerminalDecisionKind.STOP_NO_PROGRESS: RunFinalStatus.GOLD_STOPPED_NO_PROGRESS,
